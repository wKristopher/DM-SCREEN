...
export const ACTIONS_IN_COMBAT: RefEntry[] = [
  ...
  { name: 'Disarm', desc: 'Bir saldırı yerine: saldırı zarı, hedefin STR (Athletics) veya DEX (Acrobatics) kontrolüne karşı. Silah iki elle tutuluyorsa hedef **advantage**.' },
  { name: 'Overrun / Tumble', desc: 'STR (Athletics) veya DEX (Acrobatics) contest. Kazanırsan bu tur hasım hedefin alanından bir kez geçebilirsin.' },
]
...
export const REF_TABLES: RefTable[] = [
  ...
  {
    id: 'weapon-props',
    title: 'Silah Özellikleri',
    subtitle: 'Weapon Properties',
    accent: 'rose',
    kind: 'grid',
    columns: ['Özellik', 'Anlamı'],
    rows: [
      ['Ammunition', 'Cephane harcar; elde cephane kalmazsa saldırılamaz'],
      ['Finesse', 'Saldırı ve hasarda STR yerine DEX kullanılabilir'],
      ['Heavy', 'Küçük (small) veya daha ufak yaratıklar saldırıda **disadvantage**'],
      ['Light', 'İki silahla dövüşmeye uygun'],
      ['Loading', 'Turda yalnızca bir kez ateşlenebilir (bonus action’la bile)'],
      ['Range', 'Normal/azami menzil; azamiyi aşan atışlar **disadvantage**'],
      ['Reach', 'Menzile +5 ft ekler (saldırı ve opportunity attack)'],
      ['Thrown', 'Fırlatılarak menzilli saldırı yapılabilir, normal hasarla'],
      ['Two-Handed', 'Kullanmak için iki el gerekir'],
      ['Versatile', 'Tek elle veya iki elle (daha yüksek hasar zarıyla) kullanılabilir'],
    ],
  },
  {
    id: 'currency',
    ...
    accent: 'sage',
    kind: 'grid',
    columns: ['Sikke', 'Bakır (cp) karşılığı'],
    rows: [
      ['Bakır (cp)', '1'],
      ['Gümüş (sp)', '10'],
      ['Elektrum (ep)', '50'],
  ...
  {
    id: 'ability-mods',
    title: 'Yetenek Puanı → Bonus',
    subtitle: 'Ability Modifiers',
    accent: 'accent',
    kind: 'grid',
    columns: ['Puan', 'Bonus'],
    rows: [
  ...
  },
  {
    ...
    subtitle: 'Light Sources',
    accent: 'violet',
    kind: 'grid',
    columns: ['Kaynak', 'Parlak', 'Sönük', 'Süre'],
    rows: [
      ['Mum', '5 ft', '+5 ft', '1 saat'],
      ['Lamba', '15 ft', '+30 ft', '6 saat'],
      ['Fener, yönlü (bullseye)', '60 ft koni', '+60 ft', '6 saat'],
      ['Fener, kapaklı (hooded)', '30 ft', '+30 ft', '6 saat'],
      ['Meşale', '20 ft', '+20 ft', '1 saat'],
    ],
  },
  {
    id: 'lifestyle',
    title: 'Yaşam Tarzı Giderleri',
    subtitle: 'Lifestyle Expenses',
    accent: 'sage',
    kind: 'grid',
    columns: ['Yaşam Tarzı', 'Gün / Fiyat'],
    rows: [
      ['Sefil (Wretched)', '—'],
      ['Perişan (Squalid)', '1 sp'],
      ['Yoksul (Poor)', '2 sp'],
      ['Mütevazı (Modest)', '1 gp'],
      ['Konforlu (Comfortable)', '2 gp'],
      ['Zengin (Wealthy)', '4 gp'],
      ['Aristokrat (Aristocratic)', '10 gp ve üzeri'],
    ],
  },
  {
    id: 'misc-rules',
    title: 'Diğer Kurallar',
    subtitle: 'Odds & Ends',
    accent: 'azure',
    kind: 'grid',
    columns: ['Konu', 'Kural'],
    rows: [
      [
        'Concentration bozulma',
        'Hasar alma (CON save DC 10 veya yarı hasar), incapacitated olma veya ölüm, başka bir concentration büyüsü, aşırı dikkat dağıtıcı bir olay (DC 10 CON save)',
      ],
      [
        'Sıkışma (Squeezing)',
        'Bir boyut küçük boşluktan geçilebilir; hareket eden her fit için +1 fit harcanır, saldırı ve DEX save’lerde **disadvantage**',
      ],
      [
        'Nefessiz kalma (Suffocating)',
        'CON mod kadar dakika (min 30 sn) nefes tutulabilir; bittiğinde CON mod kadar tur (min 1) dayanılır, sonra 0 HP’ye düşülür ve nefes alana dek iyileşilemez',
      ],
      [
        'İki Silahla Dövüşme',
        'Light bir silahla Attack action alınca, bonus action’la farklı bir light silahla ek saldırı yapılabilir; bu ekstra saldırının hasarına ability mod eklenmez (negatifse eklenir)',
      ],
      [
        'Binicilik (Mounted Combat)',
        'Binme/inme hareketin yarısını harcar. Yönlendirilen (controlled) binek inisiyatifinizi paylaşır ve yalnızca Dash/Disengage/Dodge yapabilir; bağımsız (independent) binek kendi inisiyatifini ve tüm eylemlerini korur',
      ],
    ],
  },
]
